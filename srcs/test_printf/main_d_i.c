...
/*   Updated: 2019/07/10 10:59:34 by rsteigen      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
/*
**	Simple test
**	test print (biggest neg)
*/
//	printf("printf:\t\t %d, %d, %d, %d\n", pos, neg, biggest_neg,\
	biggest_pos);
//	printf("return (printf): %d\n", printf("printf:\t\t %d, %d, %d, %d\n",\
//	pos, neg, biggest_neg, biggest_pos));
...
*/
/*
	printf("P: hh pos, char (-128 tm 127): %hhi\n", hh_char_pos);
	ft_printf("hh pos, char (-128 tm 127): %hhi\n", hh_char_pos);
	printf("P: hh neg, char (-128 tm 127): %hhi\n", hh_char_neg);
	ft_printf("hh neg, char (-128 tm 127): %hhi\n", hh_char_neg);
	printf("P: hh error, char (-128 tm 127): %hhi\n", -130);
	ft_printf("hh error, char (-128 tm 127): %hhi\n", -130);
	printf("P: h pos, short (-32768 tm 32767): %hd\n", h_short_pos);
	ft_printf("h pos, short (-32768 tm 32767): %hd\n", h_short_pos);
	printf("P: h neg, short (-32768 tm 32767): %hd\n", h_short_neg);
	ft_printf("h neg, short (-32768 tm 32767): %hd\n", h_short_neg);

	printf("P: h error, short (-32768 tm 32767): %hd\n", -33000);
	ft_printf("h error, short (-32768 tm 32767): %hd\n", -33000);
	printf("P: no h error, short (-32768 tm 32767): %d\n", -33000);
	ft_printf("no h error, short (-32768 tm 32767): %d\n", -33000);

	printf("\n5248976532849578978\nP: l pos, long (-2147483648 tm 2147483647): %ld\n", l_long_pos);
	ft_printf("l pos, long (-2147483648 tm 2147483647): %ld\n", l_long_pos);
	printf("P: no l pos, long (-2147483648 tm 2147483647): %d\n", l_long_pos);
	ft_printf("no l pos, long (-2147483648 tm 2147483647): %d\n", l_long_pos);

	printf("\n-5248976532849578978\nP: l neg, long (-2147483648 tm 2147483647): %ld\n", l_long_neg);
	ft_printf("l neg, long (-2147483648 tm 2147483647): %ld\n", l_long_neg);
	printf("P: no l neg, long (-2147483648 tm 2147483647): %d\n", l_long_neg);
	ft_printf("no l neg, long (-2147483648 tm 2147483647): %d\n", l_long_neg);
...
*/
/*
//	printf("P: l error, long (-2147483648 tm 2147483647): %ld\n", 999999999999999999999);
//	ft_printf("l error, long (-2147483648 tm 2147483647): %ld\n", 999999999999999999999);
	printf("P: ll pos, longlong (-9223372036854775807 tm 9223372036854775807): %lld\n", ll_longlong_pos);
	ft_printf("ll pos, longlong (-9223372036854775807 tm 9223372036854775807): %lld\n", ll_longlong_pos);
	printf("P: ll neg, longlong (-9223372036854775807 tm 9223372036854775807): %lld\n", ll_longlong_neg);
	ft_printf("ll neg, longlong (-9223372036854775807 tm 9223372036854775807): %lld\n", ll_longlong_neg);
//	printf("P: ll error, longlong (-9223372036854775807 tm 9223372036854775807): %lld\n", 999999999999999999999);
